<template>
   <div class="wordCloud border" ref="wordCloud"></div>
</template>
...
export default {
  ...
  data () {
		return {
			// words: ['万事如意', '事事如意 ', '万事亨通', '一帆风顺', '万事大吉', '吉祥如意', '步步高升', '步步登高', '三羊开泰', '得心应手', '财源广进', '陶未媲美', '阖家安康', '龙马精神', '锦绣前程', '吉祥如意', '生龙活虎', '神采奕奕', '五谷丰登', '马到成功', '飞黄腾达', ' 步步高升', '福禄寿禧'],
			color: [
...
.border {
        ...
        linear-gradient(to bottom, #24d5ff, #24d5ff) left top no-repeat,
        ...
        linear-gradient(to left, #24d5ff, #24d5ff) right bottom no-repeat;
